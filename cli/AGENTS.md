...
Global npm package (`9router`) that bundles the Next.js dashboard + SSE engine into a single installable CLI with system tray, port management, and self-healing dependencies.
