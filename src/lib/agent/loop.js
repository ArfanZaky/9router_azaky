    ...
    for (const call of toolCalls) {
      ...
      if (call.name.startsWith("mcp__") && onMcpCall) {
        ...
        result = await executeTool(call.name, call.arguments, {
          ...
          onTeamRoster: depth < 2 ? onTeamRoster : null,
          onTeamTask: depth < 2 ? onTeamTask : null,
          onTeamMessage: depth < 2 ? onTeamMessage : null,
          onTeamBroadcast: depth < 2 ? onTeamBroadcast : null,
          onApproval,
          onAskUser,
          onGoalJudge,
